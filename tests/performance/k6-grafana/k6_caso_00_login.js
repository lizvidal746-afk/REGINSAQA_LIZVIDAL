...
const sleepRequested = Number.parseFloat(__ENV.K6_SLEEP_SECONDS || '0');
const K6_SLEEP_SECONDS = Number.isFinite(sleepRequested) && sleepRequested >= 0 ? sleepRequested : 0;

...
Write-Host 'Ejecutando Caso 04 en modo scale...'
& npx playwright test tests/casos-prueba/04-reconsiderar-con-sanciones.spec.ts --retries=$retries @PlaywrightArgs
